                                        ...
                                        <tbody>
												...
												$query=mysqli_query($db,$sql);
													...
													if(!mysqli_num_rows($query) > 0 )
														{
															echo '<td colspan="11"><center>No Menu Available</center></td>';
														}
													else
														{				
																	while($rows=mysqli_fetch_array($query))
																		{
																					...
																					echo '<tr><td><div class="col-md-3 col-lg-8 m-b-10">
                                                                                                <center><img src="Res_img/dishes/'.$rows['img'].'" class="img-responsive  radius" style="height:100px;width:150px;" /></center>
                                                                                                </div></td>
