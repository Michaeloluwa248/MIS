...
if(isset($_POST['btnSubmitFeedback'] ))
{
 ...
 else
 {
  ...
  $mql = "INSERT INTO feedback (u_id,title,message,date) VALUES('".$_SESSION['user_id']."','".$_POST['title']."','".$_POST['message']."','".$date."')";
  mysqli_query($db, $mql);
    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12">
          <div class="bg-gray">
            <div class="card-body">
              <h6 class="mb-0"><i class="fa fa-book"></i> Feedback Form</h6>
              <form method="POST" action="feedback.php">
                <div class="row">
                  <div class="col-6 mt-2">
                    <div class="form-group">
                      <label>Title</label>
                      <input type="text" name="title" class="form-control" placeholder="I love this food">
                    </div>
                    <div class="form-group">
                      <label>Message</label>
                      <textarea type="email" rows="8" name="message" class="form-control"></textarea>
                    </div>
                    <div class="form-group">
                      <input type="submit" value="Submit Feedback" name="btnSubmitFeedback" class="btn btn-md btn-primary">
