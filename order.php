          ...
          <div class="col-xs-12">
            <div class="bg-gray">
              ...
              <tbody>
               ...
               $query_res= mysqli_query($db,"SELECT * from users_orders where invoiceno='".$_GET['inv']."'");
              ...
              {			      
                ...
                while($row=mysqli_fetch_array($query_res))
                {
                 ...
                 <td data-column="Date"> <?php echo $row['date']; ?></td>
											<!-- <td data-column="Action"> <a href="delete_orders.php?remove_item=<?php echo $row['o_id'];?>" onclick="return confirm('Are you sure you want to remove this item?');" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
											</td> -->
