          ...
          <div class="col-xs-12">
            ...
            <div class="bg-gray">
              ...
              <tbody>
               ...
               $query_res= mysqli_query($db,"SELECT * FROM user_payment WHERE u_id='".$_SESSION['user_id']."'");
              ...
              {			      
                ...
                while($row=mysqli_fetch_array($query_res))
                {
                 ...
                 <td data-column="Action"> 
                  <a href="order.php?inv=<?php echo $row['invoiceno'];?>" target="_blank" class="btn btn-info btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-eye" style="font-size:16px"></i></a>
                  <?php 
                  $status=$row['status'];
                  if($status == "0" || $status == "1")
                  {
                    ?>
                    <a href="delete_orders.php?order_del=<?php echo $row['invoiceno'];?>" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
                    <?php
                  }
                  ?>
                </td>
